    ...
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".main-navbar">
                ...
                <img src="{{asset('images/logo.png')}}" alt="One of the best themes ever">Travel
            </a>
        </div>
    ...
    <section class="section swatch-red-white">
        <div class="container">
            <header class="section-header underline">
                <h1 class="headline hyper hairline">Toure</h1>
                <p class="big">flat design, from another angle</p>
            </header>
        </div>
    </section>
            ...
            <div class="row">
                <ul class="list-unstyled row box-list">
                    ...
                    <li class="col-md-3 text-center os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".9s">
                        ...
                        <h3 class="text-center">
                            <a href="single-service.html">100% support</a>
                        </h3>
            ...
            <div class="text-default os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".0s">
                ...
                <div class="portfolio isotope no-transition portfolio-hex portfolio-shadows row">
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-gallery filter-image">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-8-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Gallery items</a>
                                </h4>
                                <p>You think water moves fast? You should see ice.</p>
                                <a class="magnific-gallery more" data-links="images/design/vector/img-4-1200x600.png ,assets/images/design/vector/img-3-1200x600.png" data-prev-text="Previous" data-next-text="Next">
                    ...
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-video">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-4-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Vimeo Item</a>
                                </h4>
                    ...
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-video filter-image">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-1-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Integer sollicibulum</a>
                                </h4>
                                <p>After the avalanche it took us a week to climb out.</p>
                                <a class="magnific more" href="{{asset('images/design/vector/img-1-1200x600.png')}}" title="Quisque porta" data-prev-text="Previous" data-next-text="Next">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                                <a class="link" href="portfolio-item-big.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-video filter-image filter-gallery">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-5-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Quisque porta</a>
                                </h4>
                                <p>I was living in his world, a world where chaos rules not order.</p>
                                <a class="magnific more" href="{{asset('images/design/vector/img-5-1200x600.png')}}" title="Quisque porta" data-prev-text="Previous" data-next-text="Next">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                                <a class="link" href="portfolio-item-big.html">
                                    <i class="fa fa-link"></i>
                    ...
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-video">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-2-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Youtube video</a>
                                </h4>
                                <p>You think water moves fast? You should see ice.</p>
                    ...
                    <div class="portfolio-item infinite-item col-md-4 col-sm-4 filter-image filter-gallery">
                        <figure class="portfolio-figure">
                            <a href="portfolio-item-big.html">
                                <img width="600" height="518" src="{{asset('images/design/vector/img-3-600x518.png')}}" class="img-responsive" alt="some image">
                            </a>
                            <figcaption>
                                <h4>
                                    <a href="portfolio-item-big.html">Quisque porta</a>
                                ...
                                <a class="magnific more" href="{{asset('images/design/vector/img-3-1200x600.png')}}" title="Quisque porta" data-prev-text="Previous" data-next-text="Next">
                                    <i class="fa fa-search-plus"></i>
                                </a>
                                <a class="link" href="portfolio-item-big.html">
                                    <i class="fa fa-link"></i>
            ...
            <div class="row">
                <ul class="list-unstyled row box-list">
                    <li class="col-md-4 os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".0s">
                        ...
                        <h3 class="text-center">
                            <a href="about-me.html">John Langan</a>
                    ...
                    <li class="col-md-4 text-center os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".3s">
                        ...
                        <h3 class="text-center">
                            <a href="about-me.html">Kate Ross</a>
                    ...
                    <li class="col-md-4 text-center os-animation" data-os-animation="fadeInUp" data-os-animation-delay=".6s">
                        ...
                        <h3 class="text-center">
                            <a href="about-me.html">Manos Jones</a>
                        ...
                        <div class="row">
                                ...
                                <div class="grid-post swatch-red-white">
                                    <article class="post post-showinfo">
                                        <div class="post-media">
                                            <a class="feature-image magnific hover-animate" href="{{asset('images/design/vector/img-4-800x700.png')}}" title="Thats a nice image">
                                                <img alt="some image" src="{{asset('images/design/vector/img-4-800x700.png')}}">
                                                <i class="fa fa-search-plus"></i>
                                            </a>
                                        </div>
                                        <div class="post-head text-center">
                                            <h3 class="post-title">
                                                <a href="post.html">This theme is so nice!</a>
                                            </h3>
                                        ...
                                        <div class="post-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, quo, veniam culpa maiores iure distinctio atque similique veritatis rem et adipisci eveniet aspernatur aut sapiente amet doloremque eos quasi numquam.</p>
                                        ...
                                        <div class="post-extras">
                                            <div class="text-center">
                                                ...
                                                <span class="post-tags">
                                                    ...
                                                    <a href="post.html">responsive,</a>
                                                    <a href="post.html">metro</a>
                                                </span>
                                            </div>
                                            <div class="text-center">
                            ...
                            <div class="col-md-4">
                                <div class="grid-post swatch-red-white">
                                    <article class="post post-showinfo">
                                        ...
                                        <div class="post-head text-center">
                                            <h3 class="post-title">
                                                <a href="post.html">Bootstrap is Really Important</a>
                                            </h3>
                                            <small class="post-author">
                                        ...
                                        <div class="post-body">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis, quo, veniam culpa maiores iure distinctio atque similique veritatis rem et adipisci eveniet aspernatur aut sapiente amet doloremque eos quasi numquam. In lobortis eget ipsum vestibulum tristique. Donec luctus, dolor ut scelerisque luctus, erat elit consectetur arcu, eu pellentesque felis nulla sed massa. Nunc enim sem, ullamcorper ac tincidunt eget, euismod nec leo. Nunc imperdiet fringilla erat, sit amet iaculis ipsum congue et.</p>
                                            <a class="more-link" href="post.html">read more</a>
                                        </div>
                                        <div class="post-extras">
                                            <div class="text-center">
                            ...
                            <div class="col-md-4">
                                <div class="grid-post swatch-red-white">
                                    <article class="post post-showinfo">
                                        <div class="post-media">
                                            <div id="slider-flex5" class="flexslider text-left feature-slider" data-flex-speed="7000" data-flex-animation="slide" data-flex-controls="hide" data-flex-directions="show" data-flex-controlsalign="center" data-flex-captionhorizontal="" data-flex-captionvertical="" data-flex-controlsposition="" data-flex-directions-type="">
                                                <ul class="slides">
                                                    <li>
                                                        <img src="{{asset('images/design/vector/img-5-800x600.png')}}" alt="some image">
                                                    </li>
                                                    <li>
                                                        <img src="{{asset('images/design/vector/img-3-800x600.png')}}" alt="some image">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="post-head text-center">
                                            <h3 class="post-title">
                                                <a href="#">It is cool &amp; responsive</a>
                                            </h3>
                                            <small class="post-author">
                                    ...
                                    <article class="post post-showinfo">
                                        <div class="post-media">
                                            <a class="feature-image magnific-youtube hover-animate" href="http://www.youtube.com/watch?v=cfOa1a8hYP8" title="Thats a nice image">
                                                <img alt="some image" src="{{asset('images/design/vector/img-2-800x600.png')}}">
                                                <i class="fa fa-play"></i>
                                            </a>
                                        </div>
                                        <div class="post-head text-center">
                                            <h3 class="post-title">
                                                <a href="post.html">Everybody loves it</a>
                                            </h3>
                                            <small class="post-author">
                            ...
                            <div class="col-md-4">
                                <div class="grid-post swatch-red-white">
                                    <article class="post post-showinfo">
                                        ...
                                        <div class="post-head text-center">
                                            <h3 class="post-title">
                                                <a href="post.html">It is so cheap</a>
                                            </h3>
                                            <small class="post-author">
                                        ...
                                        <div class="post-body">
                                            <blockquote>
                                                <p>Cras aliquet felis in magna accumsan, sit amet mattis arcu auctor. Nunc sollicitudin auctor adipiscing. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Etiam lacus ante, egestas id pellentesque vel, tempus at justo.</p>
                                                <small>Chris Pantazis
                                        ...
                                        <div class="post-extras">
                                            <div class="text-center">
                                                <span class="post-category">
                                                    <a href="post.html">
                                                        <i class="fa fa-folder-open"></i> Flat
                                                    </a>
                                                </span>
                                                <span class="post-tags">
                                                    <i class="fa fa-tags"></i>
                                                    <a href="post.html">design,</a>
                                                    <a href="post.html">quotes</a>
                                                </span>
                                            </div>
                                            <div class="text-center">
                                                <span class="post-link">
                                    ...
                                    <article class="post post-showinfo">
                                        <div class="post-media">
                                            <a class="feature-image magnific-vimeo hover-animate" href="http://vimeo.com/20061744" title="Let&#x27;s talk about it">
                                                <img alt="some image" src="{{asset('images/design/vector/img-1-800x600.png')}}">
                                                <i class="fa fa-play"></i>
                                            </a>
                                        </div>
                                        <div class="post-head text-center">
...
<div id="style-switcher">
    ...
    <div class="switcher-inner text-center">
        <button class="btn btn-switcher" role="menu">
            <i class="fa fa-cog"></i>
        </button>
        <h4>
        ...
        <ul class="theme-colors">
            <li>
                <a class="colour-switch swatch-green-white" data-swatch="swatch-green-white" data-swatch-inverse="swatch-white-green">Green</a>
            </li>
            <li>
                <a class="colour-switch swatch-blue-white" data-swatch="swatch-blue-white" data-swatch-inverse="swatch-white-blue">Blue</a>
            </li>
            <li>
                <a class="colour-switch swatch-black-beige" data-swatch="swatch-black-beige" data-swatch-inverse="swatch-beige-black">Black</a>
            </li>
            <li>
                <a class="colour-switch swatch-black-yellow" data-swatch="swatch-black-yellow" data-swatch-inverse="swatch-yellow-black">Yellow</a>
            </li>
            <li>
                <a class="colour-switch swatch-red-white" data-swatch="swatch-red-white" data-swatch-inverse="swatch-white-red">Red</a>
            </li>
            <li>
                <a class="colour-switch swatch-black-white" data-swatch="swatch-black-white" data-swatch-inverse="swatch-white-black">White</a>
            </li>
        </ul>
        <p>you can create unlimited colour variations using the <strong>Swatch color editor</strong></p>
        <h4 class="margin-top"><span>Layout</span></h4>
        <ul class="theme-layout">
            <li>
                <a class="layout-switch normal-layout" data-layout="layout-normal">Normal</a>
            </li>
            <li>
                <a class="layout-switch boxed-layout" data-layout="layout-boxed">Boxed</a>
            </li>
            <li>
            </li>
        </ul>
...
<script src="{{asset('js/packages.min.js')}}"></script>
<script src="{{asset('js/theme.min.js')}}"></script>
<script src="{{asset('js/switcher.min.js')}}"></script>
</body>
<!-- Mirrored from anglehtml.oxygenna.com/ by AzuzToGo, Fri, 02 Jan 2015 16:54:29 GMT -->
</html>
