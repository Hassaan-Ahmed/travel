        ...
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tours">
                ...
                <ul class="sidenav-second-level collapse" id="collapseTours">
                    <li>
                        <a href="{{url('#')}}" >Create a new Tour</a>
                    </li>
                    <li>
                        <a href="#">View Tours</a>
                    </li>
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Destinations">
                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseDestinations" data-parent="#exampleAccordion">
                    <i class="fa fa-fw fa-wrench"></i>
                    <span class="nav-link-text">Destinations</span>
                </a>
                <ul class="sidenav-second-level collapse" id="collapseDestinations">
                    <li>
                        <a href="#">Create new destination</a>
                    </li>
                    <li>
